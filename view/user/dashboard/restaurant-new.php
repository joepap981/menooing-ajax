  ...
  <div class="col-md-7" id="restaurant-information-input">
    ...
    <form>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="zipcode" placeholder="Chinese, Mexican, Burger...">
      </div>
    </form>
    <a href='#' ng-click="selectPage('restaurant')"><img id="circular-button" src="/img/left-arrow-circular-button.png"></a>
    <a href='#' ng-click="selectPage('restaurant')"> <img id="circular-button" src="/img/right-arrow-circular-button.png"></a>
  </div>
  <div class="col-md-5">
