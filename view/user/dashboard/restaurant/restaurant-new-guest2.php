    ...
    <form name="restaurantRegistration" class="restaurant-information-form">
      ...
      <div class="ml-3">
        <div class="form-group row">
          ...
          <input id="restaurantAddFile" class="to-right" type="file"  file-input ="user_ssn" placeholder="">
        </div>
        <div class="form-group row">
          ...
          <input id="restaurantAddFile" class="to-right" type="file"  file-input ="user_cert" placeholder="">
        </div>
      </div>
